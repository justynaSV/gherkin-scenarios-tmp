...
If `$ARGUMENTS` is a Jira issue URL (e.g. `https://<site>.atlassian.net/browse/<KEY>`) or a bare issue key (e.g. `PROJ-123`), use the Atlassian MCP tools to fetch that epic/story instead of asking the user to paste it:
